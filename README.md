...
const supabaseClient = createClient(supabaseUrl, supabaseKey);
  ...
  <script>
    ...
    const supabaseUrl = 'https://jmjtidxsdzndqzpuhwgf.supabase.co';  // Replace with your Supabase URL
    const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImptanRpZHhzZHpuZHF6cHVod2dmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjQ2OTgyODIsImV4cCI6MjA4MDI3NDI4Mn0.mgg2ykUleHGuJ1XZhivw0oSc8mJwPOd4MmLNIIMmVZs';  // Replace with your Supabase Key
